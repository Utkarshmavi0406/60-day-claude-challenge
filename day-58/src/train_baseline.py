...
from feature_config import NUMERIC_FEATURES, TARGET_COL

DATA_PATH = Path("data/processed/clean_loans.csv")
MODEL_DIR = Path("models")
REPORTS_DIR = Path("reports")
# NUMERIC_FEATURES, TARGET_COL now imported from feature_config.py —
# single source of truth (Day 8 QA fix, see src/feature_config.py docstring).
