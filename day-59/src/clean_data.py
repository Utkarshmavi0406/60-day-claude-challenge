...
from feature_config import NUMERIC_FEATURES, TERM_COLUMN, CATEGORICAL_ONEHOT_PREFIXES
...
# NUMERIC_FEATURES, TERM_COLUMN, CATEGORICAL_ONEHOT_PREFIXES now imported
# from feature_config.py — single source of truth (Day 8 QA fix: these
# were previously hand-duplicated here and in train_baseline.py /
# api/model_loader.py, a real maintainability risk found during review).
